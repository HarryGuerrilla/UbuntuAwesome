...
beautiful.init("/home/tony/.config/awesome/themes/zenburn.tony/theme.lua")
--beautiful.init("/home/tony/.config/awesome/themes/conscience/theme.lua")
...
tags = {
   name = { " home ", " www ", " chat ", " emacs ", " files ", " vm " },
   layout = { layouts[1], layouts[4], layouts[5], layouts[5], layouts[4], layouts[6] }
}
for s = 1, screen.count() do
    -- Each screen has its own tag table.
--    tags[s] = awful.tag({ 1, 2, 3, 4, 5, 6, 7, 8, 9 }, s, layouts[1])
--    tags[s] = awful.tag({" home ", " www ", " chat ", " emacs ", " files ", " vm "}, s, layouts[1])
...
local util = require('awful.util')
 ...
 filedir = "/home/tony/.config/awesome/launchbar/" -- Specify your folder with shortcuts here
 local items = {}
 ...
 for f in files:lines() do
     ...
     table.insert(items, { image = find_icon(getValue(t,"Icon"),
                                             { "/home/tony/.icons/Faenza/apps/32/" }),
...
--            launchbar,
    ...
    -- Create launcherbox
    launcherbox[s] = awful.wibox({ position = "left", screen = s, width = "36", bg = "#00000099" })
    launcherbox[s].widgets = {
       {
          launchbar,
...
menubar.set_icon_theme( "default" )
